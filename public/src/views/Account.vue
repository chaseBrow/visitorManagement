  ...
  <v-container background fill-height fluid>
    <v-row class="mx-4 d-flex justify-center primary" style="height: 35%">
      <v-col cols="6" class="primary" style="height: 100%">
        <v-row>
          <span
            style="padding: 0px 0px 0px 20px; font-size: 32px; font-weight: bold;"
        ...
        <v-row style="height: 60px">
          <v-text-field
            label="Username"
            v-bind="{ readonly: !edit, rounded: !edit, outlined: edit }"
        ...
        <v-list class="access secondary" style="height: 70%; border-radius: 0">
          ...
          >
            ...
            <v-btn
              ...
              x-small
              class="accent"
              v-on:click="deleteAccessOption(option)"
            >
        ...
        <v-list class="client secondary" style="border-radius: 0; height: 87%">
          <v-list-item v-for="client in clients" :key="client.username">
            <span class="primary--text" style="width: 25%">
              {{ client.get("name") }}</span
            >
            <span class="primary--text" style="width: 25%">
              {{ client.get("username") }}</span
            >
    ...
    <v-dialog v-model="dialog" persistent width="400px">
      <v-card>
        ...
        <div class="d-flex justify-space-around">
          ...
          <v-btn
            class="accent mb-5"
            v-bind="{ loading: cancelLoading }"
            v-on:click="submitCancel()"
          >
            Cancel
          </v-btn>
        </div>
    ...
    <v-alert
      ...
      v-model="resPassErr"
    >
      An error occurred while resetting password.<br />
